...
def test_missing_end_time_value():
    ...
    assert result["start_time"].iloc[0].value == "2024-11-06 18:20:28"
    assert result["start_time"].iloc[1] == "2024-11-07 18:20:28"
    assert result["start_time"].iloc[2] == "2024-11-7 18:20:28"

    assert result["end_time"].iloc[0] == "2024-11-08 18:35:28"
    assert result["end_time"].iloc[1] == current_datetime
    assert result["end_time"].iloc[2] == current_datetime
