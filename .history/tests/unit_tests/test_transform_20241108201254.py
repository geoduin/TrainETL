...
def test_cleanup_missing_values():
    ...
    mock = Mock(MissingEndDateTransformer._fill_current_date)
    mock.return_value = datetime(2024, 11, 7, 19, 30, 32).strftime("%Y-%m-%d %H:%M:%S")
    ...
    assert result["duration"].iloc[1] == 50
