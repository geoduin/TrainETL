...
def test_column_splitter_correct_horizontal_split():
    ...
    assert first_result.columns == ["rdt_id", "rdt_lines", "rdt_lines_id", "BeginStation", "EndStation"]
    assert first_result["BeginStation"].values == "Den Haag HS"
    assert first_result["EndStation"].values == "Den Haag HS"
