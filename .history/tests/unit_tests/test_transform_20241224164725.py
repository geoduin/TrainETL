...
def test_scd1_add_records():
    connection_string = os.environ.get("SNOWFLAKE_CONNECTION", None)
    ...
    record_four = {"id": 2, "name": "Alice", "age": 35, "city": "Amsterdam"}
    record_five = {"id": 4, "name": "Alice", "age": 30, "city": "Utrecht"}
    dff = pd.DataFrame([record_one, record_two, record_three, record_four, record_five]) 