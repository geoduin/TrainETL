...
def test_missing_end_time_value():
    ...
    data = pd.DataFrame({"end_time": ["2024-11-08 18:35:28", None, None], "start_time": ["2024-11-06 18:20:28", "2024-11-07 18:20:28", "2024-11-7 18:20:28"]}, dtype=["datetime", "datetime"])
