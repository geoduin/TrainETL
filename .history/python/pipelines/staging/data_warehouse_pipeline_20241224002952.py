...
class DataWarehousePipeline(Pipeline):
    ...
    def _load(self):
        ...
        self.sql_load.load_data(self.dim_date, "Temp_Cause", **config)
        self.sql_load.load_data(self.dim_date, "Temp_Stations", **config)
        self.sql_load.load_data(self.dim_date, "Temp_Station_Lines", **config)
        self.sql_load.load_data(self.dim_date, "Temp_Disruptions", **config)
        print("Data loaded")
