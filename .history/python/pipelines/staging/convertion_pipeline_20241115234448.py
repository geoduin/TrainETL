...
class ConvertionPipeline(Pipeline):
    ...
    def run(self):
        ...
        self.cause_data = self.extracter.extract('SELECT DISTINCT cause_eng as cause, cause_group FROM "Disruptions";')
        ...
        self.loader.load_data(self.station_data, "Dim_DateTime")
        return super().run()
