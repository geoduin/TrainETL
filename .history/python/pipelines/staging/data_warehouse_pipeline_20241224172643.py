...
class DataWarehousePipeline(Pipeline):
    ...
    def _transform(self):
        try:
            # Transform cause
            self.transformers.merge_data(self.dim_cause, "Temp_Cause", "Dim_Cause")
            ...
            self.transformers.merge_data(self.dim_stations, "Temp_Stations", "Dim_Stations")
            # Transform Fact
            print("Transformed Fact")
            self.transformers.merge_data(self.fact_disruption, "Temp_Disruptions", "Fact_Disruptions")
            # Transform line_station
            print("Transformed lines")
            self.transformers.merge_data(self.dim_line_station, "Temp_Station_Lines", "Dim_Station_Lines")
