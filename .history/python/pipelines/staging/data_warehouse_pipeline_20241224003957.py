...
class DataWarehousePipeline(Pipeline):
    ...
    def _load(self):
        ...
        self.sql_load.load_data(self.dim_cause, "Temp_Cause", **config)
        self.sql_load.load_data(self.dim_stations, "Temp_Stations", **config)
        self.sql_load.load_data(self.dim_line_station, "Temp_Station_Lines", **config)
        self.sql_load.load_data(self.fact_disruption, "Temp_Disruptions", **config)
        print("Data loaded")
