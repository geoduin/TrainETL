...
class ConvertionTransformer(Transform):
    ...
    """
    def __init__(self, date_key_converter: DateKeyHandler, column_splitter: ColumnSplitter.ColumnSplitter):
    ...
    def run(self, data):
        ...
        line_station_table = self.splitter.split_columns(line_station_table, "rdt_lines", "-", ["begin_station", "end_station"])
