...
class ConvertionTransformer(Transform):
    ...
    def run(self, data):
        ...
        line_stations = line_end_station_joined.drop(columns=["begin_station_w", "end_station_w", "name_long"])
        line_stations.rename(columns={'id_x': 'begin_station', 'id_y': 'end_station'}, inplace=True)
