...
class ConvertionTransformer(Transform):
    ...
    def run(self, data):
        ...
        line_begin_station_joined = line_station_table.join(station_table, on=["name_long"], how=["inner"])
        line_end_station_joined = line_station_table.join(station_table, on=["name_long"], how=["inner"])
