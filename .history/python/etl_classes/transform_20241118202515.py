...
class ConvertionTransformer(Transform):
    ...
    def __init__(self, date_key_converter: DateKeyHandler, column_splitter: ColumnSplitter, convertion_pipelines: ConvertionPipeline):
    ...
    def run(self, data):
        ...
        line_station_table = disruption_table[["rdt_id", "rdt_lines", "rdt_lines_id", "rdt_station_names", "rdt_station_codes"]]
        # Drop unnecessary columns.
        disruption_table.drop(columns=["cause_nl", "cause_en", "statistical_cause_en", "cause_group", "ns_lines", "rdt_lines", "rdt_lines_id", "rdt_station_names", "rdt_station_codes"])
