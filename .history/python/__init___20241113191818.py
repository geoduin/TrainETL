...
__init__ = [CSVExtract, SQLLoad, Transform, Extract, Load, RawPipeline, CleaningPipeline, MissingEndDateTransformer, SQLHandler, ColumnSplitter, ConvertionPipeline, DataWarehousePipeline]